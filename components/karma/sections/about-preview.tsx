...
const stats = [
  { icon: Star, value: "749+", label: "разобранных матриц" },
  { icon: Award, value: "ТОП-10", label: "из 7000 учеников" },
  { icon: Users, value: "4+", label: "года практики" }
]
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative aspect-[4/5] rounded-2xl overflow-hidden">
              ...
              <div className="absolute inset-4 bg-gradient-to-br from-violet/20 via-gold/10 to-violet/20 rounded-xl flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-sm text-muted-foreground">Фото: IMG_2905.MOV</p>
                </div>
              </div>
          ...
          >
            ...
            <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
              Цифровой психолог, коуч и наставник по дате рождения. Работаю с методами
              <span className="text-gold"> «Кармическая звезда»</span>, классической нумерологией Пифагора и Сюйцай.
            </p>
            
            <p className="text-muted-foreground mb-8">
              Мой путь в эту сферу начался не из интереса — а из боли. В 2021 году я прожила сильнейший кризис, 
              который буквально разрушил прежнюю реальность. И именно цифры стали тем языком, который дал мне ответы.
            </p>
