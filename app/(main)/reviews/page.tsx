...
import { Star, Quote, Filter, MessageSquare } from "lucide-react"
import { Button } from "@/components/ui/button"
import { reviews } from "@/data/reviews"
import Link from "next/link"

const categories = ["Toate", "Consultatii", "Cursuri", "Meditatii", "Retreat"]
...
export default function ReviewsPage() {
  ...
  const filteredReviews = reviews.filter((review) => {
    ...
    const categoryMap: Record<string, string> = {
      ...
      "Cursuri": "course",
      "Meditatii": "meditation",
      "Retreat": "retreat"
    }
    return review.category === categoryMap[selectedCategory]
  })
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <h1 className="font-serif text-4xl md:text-6xl text-cream mb-6">
              Povesti de transformare
            </h1>
            <p className="text-cream/70 text-lg mb-8">
              Recenzii reale de la oameni care au parcurs calea autocunoasterii 
              impreuna cu KARMANUMBERS
            </p>
            ...
            <div className="flex items-center justify-center gap-8 text-cream/60">
              ...
              <div className="text-center">
                ...
                <p className="text-sm">nota medie</p>
              </div>
              <div className="text-center">
                <p className="font-serif text-3xl text-gold mb-1">98%</p>
                <p className="text-sm">recomanda</p>
              </div>
            </div>
          </motion.div>
        </div>
                ...
                <div className="flex gap-1 mb-4">
                  {[...Array(5)].map((_, i) => (
                    <Star
                      key={i}
                      className={`w-4 h-4 ${
                        i < review.rating ? "text-gold fill-gold" : "text-cream/20"
                      }`}
                    />
                  ))}
                </div>
                ...
                <div className="flex items-center gap-4 pt-4 border-t border-white/10">
                  ...
                  <div>
                    ...
                    <p className="text-gold text-sm">{
                      review.category === "consultation" ? "Consultatie" :
                      review.category === "course" ? "Curs" :
                      review.category === "meditation" ? "Meditatie" : "Retreat"
                    }</p>
                  </div>
                </div>
              </motion.div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <h2 className="font-serif text-2xl md:text-3xl text-cream mb-4">
              Doresti sa lasi o recenzie?
            </h2>
            <p className="text-cream/70 mb-8">
              Daca ai lucrat deja cu mine si doresti sa impartasesti experienta ta, 
