  ...
  return (
    ...
    >
      ...
      <p className="text-cream/60 mb-8">
        Присоединяйтесь к сообществу KARMANUMBERS
      </p>

      <form onSubmit={handleSubmit} className="space-y-5">
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="text-cream/80 text-sm mb-2 block">Имя</label>
          ...
          <div>
            <label className="text-cream/80 text-sm mb-2 block">Фамилия</label>
            <Input
              type="text"
              placeholder="Фамилия"
              required
              className="bg-charcoal-light/50 border-white/10 text-cream placeholder:text-cream/40 h-12"
            />
          </div>
        </div>
        ...
        <div>
          <label className="text-cream/80 text-sm mb-2 block">Телефон</label>
          <div className="relative">
            <Phone className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-cream/40" />
            <Input
              type="tel"
        ...
        <div>
          <label className="text-cream/80 text-sm mb-2 block">Пароль</label>
          <div className="relative">
      ...
      <div className="relative my-8">
        ...
        <div className="relative flex justify-center text-sm">
          <span className="px-4 bg-charcoal text-cream/40">или</span>
        </div>
      </div>

      <Button
        variant="outline"
        className="w-full border-white/10 text-cream hover:bg-white/5 h-12"
      >
