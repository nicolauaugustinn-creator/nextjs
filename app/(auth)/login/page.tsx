  ...
  return (
    ...
    >
      ...
      <p className="text-cream/60 mb-8">
        Войдите в личный кабинет для доступа к курсам и материалам
      </p>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <label className="flex items-center gap-2 cursor-pointer">
            <input
              type="checkbox"
              className="w-4 h-4 rounded border-white/20 bg-charcoal-light/50 text-gold focus:ring-gold"
            />
            <span className="text-cream/60 text-sm">Запомнить меня</span>
          </label>
