...
export const miniCourses: Course[] = [
  {
    ...
    category: "mini",
    coverImage: "/images/mini-courses/success-code.jpg",
    format: "Видео-уроки",
    duration: "3 урока",
    level: "beginner",
    modules: [],
  ...
  },
  {
    ...
    category: "mini",
    coverImage: "/images/mini-courses/planetary.jpg",
    format: "Видео-уроки",
    duration: "4 урока",
    level: "intermediate",
    modules: [],
  ...
  },
  {
    ...
    category: "mini",
    coverImage: "/images/mini-courses/trauma.jpg",
    format: "Видео-уроки",
    duration: "4 урока",
    level: "advanced",
    modules: [],
  ...
  },
  {
    ...
    category: "mini",
    coverImage: "/images/mini-courses/personality.jpg",
    format: "Видео-уроки",
    duration: "3 урока",
    level: "beginner",
    modules: [],
  ...
  },
  {
    ...
    category: "mini",
    coverImage: "/images/mini-courses/energy.jpg",
  ...
  },
  {
    ...
    category: "mini",
    coverImage: "/images/mini-courses/money.jpg",
    format: "Видео-уроки",
    duration: "5 уроков",
    level: "beginner",
    modules: [],
  ...
  },
  {
    ...
    category: "mini",
    coverImage: "/images/mini-courses/sexuality.jpg",
    format: "Видео-уроки",
    duration: "3 урока",
    level: "intermediate",
    modules: [],
  ...
  },
  {
    ...
    slug: "otnosheniya",
    title: "Отношения",
    shortDescription: "Секреты гармоничных отношений в цифрах",
    fullDescription: "Как строить отношения, исходя из своей матрицы и матрицы партнёра.",
    category: "mini",
    coverImage: "/images/mini-courses/relationships.jpg",
    format: "Видео-уроки",
    duration: "4 урока",
    level: "beginner",
    modules: [],
  ...
  },
  {
    ...
    category: "mini",
    coverImage: "/images/mini-courses/compatibility.jpg",
    format: "Видео-уроки",
    duration: "3 урока",
    level: "beginner",
    modules: [],
  ...
  },
  {
    ...
    category: "mini",
    coverImage: "/images/mini-courses/health.jpg",
    format: "Видео-уроки",
    duration: "4 урока",
    level: "beginner",
    modules: [],
  ...
  },
  {
    ...
    category: "mini",
    coverImage: "/images/mini-courses/past-life.jpg",
    format: "Видео-уроки",
    duration: "4 урока",
    level: "advanced",
    modules: [],
